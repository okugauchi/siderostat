...
Siderostat uses third-party Rust packages. The complete v0.3.0 inventory is recorded in
...
in the v0.3.0 lockfile provide license metadata.
...
`ds4-server` is selected separately and is not included in the Siderostat source tree or dependency
inventory. Its use is governed by the license terms of the selected DwarfStar source distribution.
