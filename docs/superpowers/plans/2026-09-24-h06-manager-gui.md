...
- [ ] **Step 3: Implement the minimal client/trait changes**
...
- [ ] **Step 2: Run the focused host tests and confirm RED**
...
- [ ] **Step 3: Implement the host and controls**
...
- [ ] **Step 4: Run host tests and compile checks**
...
- [ ] **Step 3: Implement the tray and worker wiring**
...
- [ ] **Step 4: Run the monitor suite and static gates**
...
- [ ] **Step 3: Implement the projection and fixture adapters**
...
- [ ] **Step 1: Build a fresh app-dev bundle from the feature branch**
...
- [ ] **Step 2: Ensure only the official app process is running**
...
- [ ] **Step 3: Run GUI smoke with a small fixture**
...
- [ ] **Step 4: Record evidence without overstating H06**
...
- [ ] **Step 3: Commit one reviewable H06 GUI purpose**
