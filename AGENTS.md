...
- ユーザーへの応答およびユーザーに公開する思考過程は日本語だけで記述する。
...
- Obsidian Vault の `Projects/siderostat/docs/archive/implementation-plan-v0.1.0.md` は完了済み刷新計画の履歴であり、恒久的なGit運用の正本として扱わない。
